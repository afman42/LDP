    ...
    <div class="modal-dialog modal-xl">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="row">
            <div class="col-6">
              <input type="number" id="NIKKTP" class="form-control" placeholder="NIK KTP">
            </div>
            <div class="col-6">
              <input type="number" id="NIKKK" class="form-control" placeholder="NIK KK">
            </div>
          </div>
          <br>
          <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-6">
              <select id="programpaket" class="form-control">
                <option>Pilih Program Paket</option>
          ...
          <div class="row">
            <div class="col-6">
              <input type="text" id="namaayah" class="form-control" placeholder="Nama Ayah">
            </div>
            <div class="col-6">
              <input type="number" id="tahunlahirayah" class="form-control" placeholder="Tahun Lahir Ayah">
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-6">
              <input type="text" id="pekerjaanayah" class="form-control" placeholder="Pekerjaan Ayah">
            </div>
            <div class="col-6">
              <input type="number" id="pendapatanayah" class="form-control" placeholder="Pendapatan Ayah">
            </div>
          </div>
          <br><br>
          <div class="row">
          ...
          <div class="row">
            <div class="col-6">
              <input type="text" id="namaibu" class="form-control" placeholder="Nama Ibu">
            </div>
            <div class="col-6">
              <input type="number" id="tahunlahiribu" class="form-control" placeholder="Tahun Lahir Ibu">
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-6">
              <input type="text" id="pekerjaanibu" class="form-control" placeholder="Pekerjaan Ibu">
            </div>
            <div class="col-6">
              <input type="number" id="pendapatanibu" class="form-control" placeholder="Pendapatan Ibu">
            </div>
          </div>
          <br><br>
          <div class="row">
          ...
          <div class="row">
            <div class="col-6">
              <input type="text" id="namawali" class="form-control" placeholder="Nama Wali">
            </div>
            <div class="col-6">
              <input type="number" id="tahunlahirwali" class="form-control" placeholder="Tahun Lahir Wali">
            </div>
          </div>
          <br>
          <div class="row">
            <div class="col-6">
              <input type="text" id="pekerjaanwali" class="form-control" placeholder="Pekerjaan Wali">
            </div>
            <div class="col-6">
              <input type="number" id="pendapatanwali" class="form-control" placeholder="Pendapatan Wali">
            </div>
          </div>
        </div>
        <div class="modal-footer justify-content-between">
...
<script>
  $(document).ready(function() {
    $('#load-siswa').load("<?= site_url('siswa/view_siswa');?>");
  });
  $(document).ready(function(){
