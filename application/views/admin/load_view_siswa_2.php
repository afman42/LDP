<?php 
$no = 1;
$siswa = $this->db->query("SELECT * FROM tbsiswa");
?>
  ...
  <tbody align="center">
    <?php foreach ($siswa->result_array() as $i) { ?>
      <tr>
        ...
        <td>
          <a href="<?= site_url('laporan/reset_siswa/'.$i['idsiswa']); ?>" class="btn btn-success" onclick="return confirm('Yakin konfirmasi pembayaran ini?')">
            <small>
